...
# Make sure this matches your app.py and init_db.py
DATABASE_NAME = 'travel_webapp.sqlite'
JSON_FILE_PATH = 'countries_data.json'  # Path to your JSON file


def seed_database():
    print(f"Seeding countries from {JSON_FILE_PATH} into {DATABASE_NAME}...")
    ...
    for country_data in countries_to_insert:
        ...
        # Check if country_code3 already exists
        ...
        try:
            cursor.execute("""
                           ...
                           VALUES (?, ?, ?, ?, ?, ?)
                           """, (country_code_alpha3, country_name, currency_code, capital, continent_name, None))
            inserted_count += 1
